...
export function NotesPage() {
    ...
    const notesToDisplay =
        categoryFilter !== ''
            ? filteredNotes.filter((note) => note.category.includes(categoryFilter))
            : filteredNotes
    ...
    return (
        <div className='mx-auto max-w-7xl my-12 space-y-6 px-5'>
            ...
            <div className='flex gap-4 flex-wrap'>
                <CategoryButton
                    category='todas'
                    toggleCategory={() => setCategoryFilter('')}
                    active={categoryFilter === ''}
                />
                <CategoryButton
                    category='trabalho'
                    toggleCategory={() => setCategoryFilter('#trabalho')}
                    active={categoryFilter === '#trabalho'}
                />
                <CategoryButton
                    category='estudos'
                    toggleCategory={() => setCategoryFilter('#estudos')}
                    active={categoryFilter === '#estudos'}
                />
                <CategoryButton
                    category='pessoal'
                    toggleCategory={() => setCategoryFilter('#pessoal')}
                    active={categoryFilter === '#pessoal'}
                />
                <CategoryButton
                    category='lembrar'
                    toggleCategory={() => setCategoryFilter('#lembrar')}
                    active={categoryFilter === '#lembrar'}
                />
                <CategoryButton
                    category='to-do'
                    toggleCategory={() => setCategoryFilter('#to-do')}
                    active={categoryFilter === '#to-do'}
                />
            </div>
