...
export function Checkbox({ categories, content, checked, toggleParam, toggleCategory }: CheckboxProps) {
    return (
        <div>
        <label>
            <input
                ...
                type="checkbox" onChange={() => toggleCategory(toggleParam)} checked={categories.includes(checked)} />
